"""Unitree G1 23-DOF velocity environment configurations."""

from .g1_23dof_constants import (
...
def g1_23dof_rough_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 23-DOF rough terrain velocity configuration."""
...
def g1_23dof_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Create Unitree G1 23-DOF flat terrain velocity configuration."""
  cfg = g1_23dof_rough_env_cfg(play=play)
